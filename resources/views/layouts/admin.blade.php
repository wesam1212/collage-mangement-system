      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item {{ Request::is('employees/*') ? 'menu-open' : '' }}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ url('/employees/add') }}" class="nav-link {{ Request::is('employees/add') ? 'active' : '' }}">➕ Add Employee</a>
              </li>
              <li class="nav-item">
                <a href="{{ url('/employees/list') }}" class="nav-link {{ Request::is('employees/list') ? 'active' : '' }}">📋 Employees List</a>
              </li>
            </ul>
          </li>
